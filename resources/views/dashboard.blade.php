                                    ...
                                    <tbody>
                                        @forelse ($accounts as $account)
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($account->data)->format('d/M/Y') }}</td>
                                                @if ($account->tipo == 1)
                                                ...
                                                <td>
                                                    <a href="" data-toggle="modal" data-target="#mdlExcluir" data-id="{{$account->id}}"
                                                        class="nav-link float-right delete">
                                                        <i class="far fa-trash-alt"></i>
                                                    </a>
                                                    <a href="{{route('account.edit',$account->id)}}" class="nav-link float-right">
        ...
        <div class="modal-dialog" >
            <div class="modal-content">
                ...
                <form class="needs-validation" action="{{route('account.destroy')}}" method="POST">
                    ...
                    <b style="font-size: 20px" class="text-danger">Tem certeza que deseja apagar essa conta?</b><br><br>
